...
function About() {
    ...
    return (
        <div style={{...contentStyle, display: 'flex', justifyContent: 'center', alignItems: 'center'}} className="content">
            <div style={{maxWidth: '800px'}}>
                <h1 className="discover" style={{letterSpacing:'1.1rem', fontWeight: '600', padding: '5% 0 1% 0', color: '#151515', fontSize: '2.5rem'}}>DISCOVER THE BEST</h1>
